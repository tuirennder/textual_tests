...
class Counter(Widget):
    ...
    # Watch the counter value and update the label when it changes.
...
class WatchApp(App[None]):
    ...
    def on_mount(self):
        ...
        # We use the method watch to set update_progress as an additional watcher 
        # to update the progress bar when the reactive attribute counter changes.
