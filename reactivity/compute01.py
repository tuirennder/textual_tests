...
class ComputedApp(App):
    ...
    # Combines reactive color components in to a Color object.
    # Textual will cache the value of compute methods, 
    ...
    # Update color attribute upon change of Color
